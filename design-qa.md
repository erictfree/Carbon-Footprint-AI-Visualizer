...
- Pass — equal world-space steps open gradually through the belt's depth, while a 45% perceptual compensation counters the pinhole projection's exaggerated speed-up and eases the final foreground step. A tracked burger moved about 22.7–23.2 px per 650 ms through the visible approach, then eased to 22.1 px while continuing to grow.
- Pass — burger bottoms, rather than sprite centers, are anchored to the plane and the contact shadow no longer reads as a glow. A physical launch interval limits the desktop lane to four burgers and the compact lane to three; twenty timed samples retained 65.5 px of full-bounding-box clearance on desktop and 9.3 px on compact.
