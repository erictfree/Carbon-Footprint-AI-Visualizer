...
- Pass — the user-drawn white line is authoritative for the sparse path: the single burger follows the original straight 46.8% → 16.8% left-lane calibration, mirrored on the right. Only packed three-wide rows receive the separate 0.5% outward rail-clearance nudge at the back.
