...
- Pass — the new background's horizon divider and lifestyle-belt fan differ from Burger Belt 2. Packed left rows retain their −2.4% rear center correction. Packed right rows keep the accepted 55.2% → 80.8% centerline and instead compress their distant column spread to 74%, opening continuously to full spacing at the foreground. This fits all three rear burgers between the center divider and outer rail without translating the row across either edge.
