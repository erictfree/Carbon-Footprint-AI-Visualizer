...
- Pass — the AI stream follows a 48.4% → 25.8% centerline. The updated foreground endpoint rotates its burger rays rightward to match the shallower photographed ramp instead of allowing the stream center to drift toward the outer-left rail.
