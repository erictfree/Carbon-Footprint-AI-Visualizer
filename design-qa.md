...
- Pass — burger bottoms, rather than sprite centers, are anchored to the plane. The populated desktop line carries eight aligned rows of three, with 18–21 burgers intersecting the visible stage and a measured minimum full-bounding-box clearance of 6.9 px across 2.4 seconds with zero intersections. Frame-by-frame tracking showed every sampled following distance widening, eliminating the apparent rear-row catch-up. Compact rows run two-wide with at least 4.2 px clearance and zero intersections.
