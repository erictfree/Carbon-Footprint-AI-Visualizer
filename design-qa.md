...
- Pass — the user-supplied white-line reference calibrates single-burger lane centers at 46.8%/53.2% at the vanishing point and 16.8%/83.2% at the foreground edge. Only packed three-wide rows receive a 0.5% outward rail-clearance nudge at the back; it blends to zero before the foreground and does not move the slow single-burger marker.
