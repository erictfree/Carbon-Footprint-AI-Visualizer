...
- Pass — the new background's horizon divider and lifestyle-belt fan differ from Burger Belt 2. Packed AI rows now use their calibrated centerline directly; the legacy −2.4% rear translation was removed because it pushed the outer rear burger off the new ramp. Packed lifestyle rows use a 54.75% → 80.35% centerline and compress only their distant column spread to 56%, interpolating to full physical spacing at the foreground.
