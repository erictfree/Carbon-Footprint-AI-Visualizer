...
- Pass — tracked lifestyle motion increased from about 174 px/s in the distance to 299 px/s during the foreground exit. All 172 samples remained at opacity 1; the final tracked bounding box began at y=601 px, fully below the 535 px stage bottom, before removal.
...
- Pass — burger bottoms, rather than sprite centers, are anchored to the plane. The populated desktop line carries six aligned rows of three, with 15–18 burgers visible and a measured minimum full-bounding-box clearance of 6.9 px across 2.4 seconds with zero intersections. Compact rows run two-wide and retained 2.4 px with zero intersections.
