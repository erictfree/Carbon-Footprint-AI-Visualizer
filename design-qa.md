...
- Pass — the new background's horizon divider and lifestyle-belt fan differ from Burger Belt 2. Packed left rows retain their −2.4% rear center correction. Packed right rows use a 54.95% → 80.55% centerline and compress only their distant column spread to 56%. That rear compression interpolates to full physical spacing at the photographed foreground edge, so all three burgers stay inside the annotated rail wedge without losing the intended burger-width-plus-air-gap clearance near the camera.
