...
- Location/grid, home, driving, diet, categorical flying, regional baseline, and comparison-opponent inputs
...
2. Adjust the default lifestyle inputs and choose total, regional baseline, diet, driving, flying, or home as the opponent.
