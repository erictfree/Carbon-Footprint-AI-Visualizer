...
Burger Works compares estimated AI carbon with lifestyle carbon through two straight burger-production lines. Both belts move at the same constant pace while burger launch cadence shows relative CO₂ flow; exact window totals remain visible below the belts.
...
- Straight, perspective-matched twin conveyors with identical burgers; a fixed belt speed and log-compressed launch cadence show the relative CO₂ rate without visual bunching
