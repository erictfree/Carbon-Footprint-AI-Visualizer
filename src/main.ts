  ...
  <dialog class="methodology" id="methodology-dialog">
    <form method="dialog">
      ...
      <dl>
        ...
        <div><dt>Map staging</dt><dd>Natural Earth 1:110m boundaries are projected onto a 3D globe; US Census state boundaries use a local flat projection. This checkpoint is anchored to the default Austin origin; arbitrary-city geocoding follows. At global scale, the AI journey and lifestyle globe use independent viewports and cameras.</dd></div>
