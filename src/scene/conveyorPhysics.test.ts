...
describe('conveyor physics', () => {
  ...
  it('expands equal world steps toward the viewer', () => {
  ...
  it('enforces physical headway without slowing sparse rates', () => {
    ...
    expect(physicalLaunchInterval(1_000, 22_000, 4)).toBe(6_286);
    expect(physicalLaunchInterval(1_000, 22_000, 3)).toBe(8_800);
  });
});
